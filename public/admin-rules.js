...
// espacio se administran en la pestaña Espacio (admin-floorplan.js) — acá solo se cargan para
...
window.Rules = (function () {
  ...
  // La lista/alta de tipos de espacio se administra en la pestaña Espacio (admin-floorplan.js) —
  // acá solo se necesita el catálogo cargado para mostrar/elegir el tipo permitido de un servicio.
