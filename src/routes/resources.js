...
const services = makeResource("services", ["name", "duration_min", "price", "cancel_window_hours", "reminder_hours", "reminder_2_minutes", "allowed_space_types", "photo_key", "featured"]);
